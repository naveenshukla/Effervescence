...
public class DevelopersList {
    ...
    static {
        ...
        developers.add(new Person(R.drawable.sample_profile,"Pranjal Paliwal","App Developer","Geekhaven","7617027345","http://fb.com/betterclever","http://github.com/betterclever",R.color.md_green_900));
